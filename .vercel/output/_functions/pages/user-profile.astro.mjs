...
import 'kleur/colors';
import { u as useAuthStore, $ as $$LayoutWSidebar } from '../chunks/LayoutWSidebar_2E1FEmW9.mjs';
import { T as Topbar } from '../chunks/Topbar_BfLjpeWR.mjs';
import { M as Main } from '../chunks/Main_DSKONqVp.mjs';
import { defineComponent, useSSRContext, ref, onMounted, watch, mergeProps, computed, withCtx, createTextVNode, reactive, markRaw, createVNode, createBlock, openBlock, toDisplayString, createCommentVNode } from 'vue';
import { T as Tag, S as Spinner } from '../chunks/Spinner_BXGqOP8H.mjs';
...
import '../chunks/Button_W6bUmV4x.mjs';
...
const NavigationMenu = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-24d0f5bc"]]);

const DELAY_MS$1 = 600;
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, searchQuery, debouncedSearchQuery, get timeoutId() {
      ...
      timeoutId = v;
    }, DELAY_MS: DELAY_MS$1, debounceInput, filteredAcceptedFriendships, emit, acceptFriendRequest, cancelFriendRequest, Input, Anchor };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
...
const Friends = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["ssrRender", _sfc_ssrRender$2]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const logoutUser = async () => {
      try {
        const { auth } = await import('../chunks/client_By8w0Agp.mjs');
        await auth.signOut();
