...
import TimelineDot from "@/domains/trip-details/components/timeline/TimelineDot.vue";
import CardActivity from "@/domains/trip-details/components/timeline/CardActivity.vue";
